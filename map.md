...
[START] ตื่นในห้องนอน
  ...
  │
  ├─ 🔄 ย้อนกลับเข้าห้องนอน → นำกุญแจมาไขประตูออกสู่โถง → 🔓 โถงทางเดิน
  │     └─ ปิดผ้าม่าน → จัดพรม → เปิดไฟบันได → 🔎 ค้นกระเป๋า (ได้บัตรรหัสที่ 1 & สมาร์ทโฟน)
  │
  ├─ ลงบันได → 🔓 ห้องครัว → ปิดก๊อก/กาต้มน้ำ/ตู้ → ปิดเตา → เลือกเครื่องปรุงปลอดภัย → ชิมอาหาร (สำเร็จ)
  ...
  │
  ├─ 🔄 ย้อนไปทางโถง → 🔓 ห้องเก็บของ → (ใช้สมาร์ทโฟนส่องแสง) แก้ปริศนาห้องเก็บของ → ได้ค้อน
  │
  ├─ 🔄 ย้อนกลับไปห้องครัว → ใช้ค้อนทุบลูกบิดที่ขึ้นสนิม → 🔓 ห้องซักล้าง
  │     └─ แก้ปริศนาห้องซักล้าง → ได้ชุดอุปกรณ์ซ่อมล้อ
  │
  ├─ 🔄 ย้อนกลับไปห้องทานข้าว → นำอุปกรณ์มาซ่อมล้อนาฬิกาลูกตุ้มและเลื่อนออก
  │
  ├─ 🔓 ห้องนั่งเล่น → ดู TV + หาแผนที่สวน + อ่านคู่มือ
  │
  ├─ (ต่อจากนี้เป็น Flow ถัดไป ... หากุญแจออกสวน, เดินตามแผนที่, ตู้ไปรษณีย์ รหัส 4 หลัก)
  │
