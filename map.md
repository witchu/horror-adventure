...
| ห้องนั่งเล่น | โถงทางเดิน, ห้องทานข้าว | 🔓 ต้องเลื่อนตู้ที่ขวางประตู (จากห้องทานข้าว) หรือลงบันไดจากโถง |
| ห้องเก็บของ | โถงทางเดิน | 🔓 ต้องมีกุญแจ (จากโถงทางเดิน) |
| ห้องซักล้าง | ห้องครัว, สวนหน้าบ้าน | 🔓 ต้องมีค้อน (จากห้องครัว) |
...
graph LR
    subgraph "🔄 Cross-Room Dependencies"
        ...
        DIN_HKEY["กุญแจจากห้องอาหาร"]
        DIN_HKEY -->|"ต้องหากุญแจ\nในห้องอาหาร"| STO_DOOR

        DIN_CABINET["ตู้ขวางประตู\nห้องทานข้าว → นั่งเล่น"]
        DIN_ITEM["ไอเทมเลื่อนตู้\nจากห้องทานข้าว"]
        DIN_ITEM -->|"ต้องหาไอเทม\nเลื่อนตู้ก่อนเข้า"| DIN_CABINET

        LAU_DOOR["ประตูห้องซักล้าง\n(ล็อค)"]
        STO_HAMMER["ค้อนจากห้องเก็บของ"]
        STO_HAMMER -->|"ต้องหาค้อน\nจากห้องเก็บของก่อน"| LAU_DOOR
